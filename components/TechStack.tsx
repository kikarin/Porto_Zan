    ...
    <section id="techstack" className="py-20 text-gray-100 relative">
      ...
      <div className="flex justify-center mb-6">
        <motion.button
          ...
          className="font-gotosans flex items-center gap-2 px-6 py-2 bg-gray-900 text-gray-300 rounded-full shadow-md hover:bg-orange-300 hover:text-gray-900 transition-all"
        ...
        {isVisible && (
          ...
          >
            ...
            <div className="text-center mb-10">
              <h2 className="text-4xl md:text-5xl font-extrabold bg-gradient-to-r from-gray-800 via-gray-900 to-gray-600 bg-clip-text text-transparent drop-shadow-lg">
                My Tech Stack
              </h2>
            ...
            {/* Filter Button */}
            <div className="font-gotosans flex flex-wrap justify-center gap-4 mb-8">
            ...
            <div className="flex justify-center">
              <motion.div
                layout
                className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-x-6 gap-y-6 px-6 md:px-12 max-w-6xl"
              >
                <AnimatePresence>
                  {techStack
                    .filter(
