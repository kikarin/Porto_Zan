...
export default function Certifications() {
  ...
  return (
    <section id="certifications" className="py-20 text-gray-700">
        {/* Header */}
        <motion.div
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
          {certifications.map((cert, index) => (
            <motion.div
              ...
              className="glass w-full max-w-xs mx-auto p-4 flex flex-col items-center justify-between text-center transition-transform hover:scale-105 backdrop-blur-md border border-white/90 shadow-lg"
            >
              {/* Gambar Sertifikat */}
              <div
